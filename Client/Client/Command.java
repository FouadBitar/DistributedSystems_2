...
public enum Command {
	...
	Start("Start a new transaction, returns transaction number",""),
	Commit("Commits the transaction","<xid>"),
	Abort("Aborts the transaction","<xid>"),
	Shutdown("Shuts down all of the transactions",""),
